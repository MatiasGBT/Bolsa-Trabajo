...
public class Conexion {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/bolsa_trabajo?useSSL=false&useTimezone=true&serverTimezone=UTC&allowPublicKeyRetrieval=true";
